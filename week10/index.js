...
const connectionString = process.env.DATABASE_URL || "postgres://ftsdzwoxbchbgy:5eb5d03aef4170b2f7b7792e5aac2b6deb525d86f1fc077deb5891128330fb92@ec2-54-235-66-1.compute-1.amazonaws.com:5432/d7kkgo3dfbjbt2?ssl=true";
...
function getPersonFromDb(id, callback) {
	...
	const sql = "SELECT id, first_name, last_name, birthdate FROM person WHERE id = $1::int";
